...
.then(data1 => {
    ...
    document.getElementById("country").innerHTML = latitude+" N "+longitude+" E";
...
function showWeatherData (data){
    ...
    data.daily.forEach((day, idx) => {
        ...
        if(idx == 0){
            ...
            <div class="other">
                <div class="day">Today<br>(${window.moment(day.dt*1000).format('dddd')})</div>
    ...
    // bar chart
    barchart.innerHTML = `<canvas id="myChart" style="width:80%;max-width:400%"></canvas>`
    var xValues = days;
